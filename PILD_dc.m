...
load D:\highimbalance\letreca\train.txt;
...
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\letreca\inv_dc1\result\basicdata_train.txt','w');
...
err_train
fid=fopen('D:\highimbalance\letreca\inv_dc1\result\err_train.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the test set.
load D:\highimbalance\letreca\test.txt;
load D:\highimbalance\letreca\nte.txt;
load D:\highimbalance\letreca\inv_dc1\result\w0.txt;
load D:\highimbalance\letreca\inv_dc1\result\w.txt;
load D:\highimbalance\letreca\inv_dc1\result\w1.txt;
...
err_test
fid=fopen('D:\highimbalance\letreca\inv_dc1\result\err_test.txt','w');
    fprintf(fid,'%g %g %g %g %g\n',err_test');
fclose(fid);
...
fid=fopen('D:\highimbalance\letreca\inv_dc1\result\Number_error_train.txt','w');
    fprintf(fid,'\nFor the train set\n');
    fprintf(fid,'\n%g %g\n',nerr');
    fprintf(fid,'\n%g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
fid=fopen('D:\highimbalance\letreca\inv_dc1\result\Number_error_test.txt','w');
    fprintf(fid,'\nFor the test set\n');
    fprintf(fid,'\n%g %g\n',nerr');
    fprintf(fid,'\n%g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
